...
const About: React.FC = () => {
  ...
  return (
    <section id="about" className="min-h-[100svh] py-20 md:py-24 px-5 sm:px-6 md:px-4 flex items-center justify-center relative bg-cosmic-900/50 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <motion.div 
            ...
            className="bg-cosmic-800/80 p-5 sm:p-6 md:p-8 rounded-xl border border-cosmic-700 backdrop-blur-sm shadow-2xl relative group"
          >
             <div className="absolute -inset-0.5 bg-gradient-to-r from-cosmic-500 to-blue-500 rounded-xl opacity-20 group-hover:opacity-40 transition duration-500 blur"></div>
             <div className="relative z-10">
                <h2 className="text-2xl sm:text-3xl font-display font-bold mb-5 md:mb-6 text-white flex items-center gap-3">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 text-gray-400">
                    <Server className="w-5 h-5 shrink-0 text-cosmic-500" />
                    <span>Fan de <strong className="text-white">Self-hosting</strong> & HomeLab</span>
                  </div>
                  <div className="flex items-center gap-3 text-gray-400">
                    <Terminal className="w-5 h-5 shrink-0 text-cosmic-500" />
                    <span>Amoureux du<strong className="text-white"> Terminal</strong></span>
                  </div>
                  <div className="flex items-center gap-3 text-gray-400">
                    <Code2 className="w-5 h-5 shrink-0 text-cosmic-500" />
          ...
          <motion.div variants={itemVariants} className="text-center md:text-left">
             ...
             <p className="text-gray-400 hover:text-gray-200 transition-colors duration-300 text-base md:text-lg leading-relaxed">
             ...
             <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
               ...
               <div className="p-4 bg-cosmic-800 rounded-lg border border-cosmic-700/50">
                 <div className="text-2xl sm:text-3xl font-bold text-white mb-1 break-words">Énormément</div>
